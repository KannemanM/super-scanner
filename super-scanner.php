 ...
 * Description:     Escanea códigos de barras y compara precios en Mas Online, Carrefour, Vea y más vía API VTEX.
 * Version:         1.0.0
...
require_once SUPER_SCANNER_PLUGIN_DIR . 'stores/class-store-vea.php';
...
function super_scanner_init() {
    ...
    $controller->add_store(new Super_Scanner_Store_Vea());
